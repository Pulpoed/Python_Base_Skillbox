...
lamps_qnt = store[goods['Лампа']][0]['quantity']
tables_qnt = store[goods['Стол']][0]['quantity'] + \
             store[goods['Стол']][1]['quantity']
couch_qnt = store[goods['Диван']][0]['quantity'] + \
...
# print('Лампа -', lamps_quantity, 'шт, стоимость', lamps_cost, 'руб. ', 'Стол -')
print('Лампа -', lamps_qnt, 'шт, стоимость', lamps_cost, 'руб. ')
print('Стол -', tables_qnt, 'шт, стоимость', tables_cost, 'руб. ')
print('Диван -', couch_qnt, 'шт, стоимость', couch_cost, 'руб. ')
print('Стул -', chair_qnt, 'шт, стоимость', chair_cost, 'руб. ')
# Вывести стоимость каждого товара на складе: один раз распечать сколько всего столов,
# стульев и т.д. на складе
# Формат строки <товар> - <кол-во> шт, стоимость <общая стоимость> руб

# WARNING для знающих циклы: БЕЗ циклов. Да, с переменными; да, неэффективно;
# да, копипаста.
# Это задание на ручное вычисление - что бы потом понять как работают циклы
# и насколько с ними проще жить.
